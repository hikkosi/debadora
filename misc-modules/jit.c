...
*/
	...
	proc_create("currentime", 0, NULL, &proc_fops);
	proc_create("jitbusy", 0, NULL, &proc_fops);
	proc_create("jitsched",0, NULL, &proc_fops);
	proc_create("jitqueue",0, NULL, &proc_fops);
	proc_create("jitschedto", 0, NULL, &proc_fops);

	proc_create("jitimer", 0, NULL, &proc_fops);
	proc_create("jitasklet", 0, NULL, &proc_fops);
	proc_create("jitasklethi", 0, NULL, &proc_fops);
